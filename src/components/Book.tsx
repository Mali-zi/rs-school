...
export default function Planet({ planet }: IPlanetProps) {
  const { name, orbital_period, population, climate, gravity } = planet;
  return (
    <div className="card border-dark mb-3 h-100 card-style">
      <div className="card-header fs-4">{name}</div>
      <div className="card-body text-dark">
        <ul className="list-group list-group-flush">
          <li className="list-group-item">orbital_period: {orbital_period}</li>
